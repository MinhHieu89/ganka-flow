...
export const mockVisits: Visit[] = [
  ...
  },
  {
    ...
    refractionData: {
      currentGlasses: {
        od: { sph: "-1.50", cyl: "-0.75", axis: "180", va: "9/10", add: "" },
        os: { sph: "-1.25", cyl: "-0.50", axis: "175", va: "10/10", add: "" },
      },
      objective: {
        od: { sph: "-2.00", cyl: "-1.00", axis: "180", va: "5/10" },
        os: { sph: "-1.75", cyl: "-0.75", axis: "170", va: "6/10" },
      },
      subjective: {
        od: { sph: "-1.75", cyl: "-0.75", axis: "180", va: "10/10", add: "", vaNear: "" },
        os: { sph: "-1.50", cyl: "-0.50", axis: "175", va: "10/10", add: "", vaNear: "" },
      },
      ...
      iop: { od: "16", os: "15" },
      axialLength: { od: "", os: "" },
      glassesRxEnabled: true,
      glassesRx: {
        od: { sph: "-1.75", cyl: "-0.75", axis: "180", va: "10/10", add: "" },
        os: { sph: "-1.50", cyl: "-0.50", axis: "175", va: "10/10", add: "" },
        pd: "63",
        lensType: "Đa tròng chống mỏi",
        purpose: "Nhìn xa + máy tính",
        notes: "",
      },
      notes: "Làm việc văn phòng nhiều giờ, khuyên nghỉ mắt 20-20-20",
    },
    scheduledAt: "09:00",
  ...
  },
  {
    ...
    refractionData: {
      currentGlasses: {
        od: { sph: "-2.00", cyl: "-0.50", axis: "180", va: "9/10", add: "" },
        os: { sph: "-1.75", cyl: "-0.25", axis: "175", va: "10/10", add: "" },
      },
      objective: {
        od: { sph: "-2.25", cyl: "-0.50", axis: "180", va: "4/10" },
        os: { sph: "-2.00", cyl: "-0.25", axis: "175", va: "5/10" },
      },
      subjective: {
        od: { sph: "-2.25", cyl: "-0.50", axis: "180", va: "10/10", add: "", vaNear: "J1" },
        os: { sph: "-2.00", cyl: "-0.25", axis: "175", va: "10/10", add: "", vaNear: "J1" },
      },
      cycloplegicEnabled: false,
      cycloplegicAgent: [],
      cycloplegic: {
      ...
      retinoscopy: { od: "-2.25/-0.50x180", os: "-2.00/-0.25x175" },
      iop: { od: "14", os: "15" },
      axialLength: { od: "24.5", os: "24.3" },
      glassesRxEnabled: true,
      glassesRx: {
        od: { sph: "-2.25", cyl: "-0.50", axis: "180", va: "10/10", add: "" },
        os: { sph: "-2.00", cyl: "-0.25", axis: "175", va: "10/10", add: "" },
        pd: "62",
        lensType: "Đơn tròng",
        purpose: "Nhìn xa",
        notes: "",
