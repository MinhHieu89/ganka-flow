...
// Full intake form data — screening uses all 7 sections
// (the receptionist intake-form.tsx was simplified to sections I + VII only)
...
export function ScreeningIntakeFormEditable({
  patient,
  onSave,
  onCancel,
